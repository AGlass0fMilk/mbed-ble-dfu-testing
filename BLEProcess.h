...
extern UARTService uart_service;
extern ChainableGapEventHandler gap_eh;
...
public:
    ...
    void start()
    {
        ...
        /* handle gap events */
//        _eh_chain.addEventHandler(this);
//        _eh_chain.addEventHandler(&uart_service);
        gap_eh.addEventHandler(this);
//        _gap.setEventHandler(&_eh_chain);
        _gap.setEventHandler(&gap_eh);
...
private:
    ...
    ChainableGapEventHandler _eh_chain;
};
